  ...
  return (
    <div className="space-y-4">
      ...
      <div className="card overflow-hidden">
        <div className="hidden sm:grid grid-cols-[1fr_auto_auto_auto_auto] gap-4 p-4 bg-[#010A13] text-xs font-medium text-[#A09B8C] uppercase tracking-wide border-b border-[#1E2328]">
          <span>유저</span>
          <span className="w-24 text-center">티어</span>
          <span className="w-20 text-right">포인트</span>
          <span className="w-16 text-center">관리자</span>
          <span className="w-36 text-right">액션</span>
        </div>
        ...
        <div className="divide-y divide-[#1E2328]">
          {filteredUsers.map((user) => {
            ...
            return (
              <div key={user.uid} className="p-4 hover:bg-[#1E2328]/50 transition-colors">
                <div className="sm:grid sm:grid-cols-[1fr_auto_auto_auto_auto] sm:gap-4 sm:items-center">
                  ...
                  <div className="flex items-center justify-between sm:contents">
                    ...
                    <div className="flex justify-end gap-2 sm:w-36">
                      <button
